...
import { Search, Globe, Layout, Map as MapIcon, Image as ImageIcon, Gamepad2, Users, Box } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-12">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-6">
          ...
          {activeTab === 'game3d' && (
             <div className="w-full h-[800px] bg-black rounded-xl overflow-hidden shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-500 border border-gray-200 relative">
